...
<div class="row">
	...
	<form:form method="post" modelAttribute="employee" enctype="multipart/form-data" autocomplete="off" class="form">
        ...
        <div class="row">
           <div class="col-lg-6">
				...
				<div class="form-group">
					<label class="control-label" for="enablePasswordChange">Edit Password</label>
					 <form:checkbox path="enablePasswordChange" class="form-contro" id="enablePasswordChange" />
					<!--  input type="checkbox" value="1"
						name="enablePasswordChange" id="enablePasswordChange" />
					<input type="hidden" value="on"
						name="_enablePasswordChange" id="_enablePasswordChange" />-->
